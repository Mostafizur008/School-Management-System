...
namespace App\Http\Controllers\Backend\Account\AccountSalary;
...
class AccountSalaryController extends Controller
{
    public function AccountSalaryView(){
    	...
    	return view('backend.main-section.page.account.employee_salary.view',$data);
    ...
    public function AccountSalaryAdd(){
      ...
      return view('backend.main-section.page.account.employee_salary.add');
    }
    ...
    public function AccountSalaryGetEmployee(Request $request){
 	...
 	$html[$key]['tdsource'] .= '<td>'.$attend['user']['em_id_no'].'<input type="hidden" name="date" value="'.$date.'" >'.'</td>';
