$(document).ready(function() {
    ...
    */
    ...
    $('body').on( 'change', '#check_passing_year',function () {
        $('#passing_year').removeAttr('disabled', 'disabled');
        $('#result').removeAttr('disabled', 'disabled');
        if ($(this).val()) {
            $('#passing_year').attr('disabled', 'disabled');
            $('#result').attr('disabled', 'disabled');
        }
    });

    $('body').on( 'change', '#materials_type',function () {
        var materials_type = $(this).val();
        $("#semester").parent().show();
        if (materials_type == 'Syllabus') {
