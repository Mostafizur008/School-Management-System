                ...
                <div class="col-sm-6 col-md-3">
                 ...
                 <div class="col-sm-6 col-md-2">
                    <div class="form-group">
                        <label>Role</label>
                        <input type="text" name="roll_3" value="{{$editData->roll_1}}" class="form-control" id="roll_3" placeholder="Enter Role">
                    </div>
                 </div>
                 ...
                 <div class="col-sm-6 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="point_3" value="{{$editData->point_1}}" class="form-control" id="point_3" placeholder="Enter Grade Point">
                    </div>
                 </div>
