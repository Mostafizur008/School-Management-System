...
<div class="col-sm-6 col-md-3">
    <div class="form-group">
        ...
        <input type="text" name="institution_1" class="form-control" id="institution_1" placeholder="Enter Institution">
    </div>
 </div>
 ...
 <div class="col-sm-6 col-md-2">
    <div class="form-group">
        <label>Role</label>
        <input type="text" name="roll_1" class="form-control" id="roll_1" placeholder="Enter Role">
    </div>
 </div>
 ...
 <div class="col-sm-6 col-md-2">
    <div class="form-group">
        ...
        <input type="text" name="point_1"  class="form-control" id="point_1" placeholder="Enter Grade Point">
    </div>
 </div>
