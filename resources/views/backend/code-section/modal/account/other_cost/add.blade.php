         ...
         <form method="post" action="{{ route('store.other.cost') }}" enctype="multipart/form-data">
           ...
           <div class="modal-body p-4">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <textarea name="description" id="description" class="form-control" required="" placeholder="Please Description Here.."></textarea>
                    </div>
                 </div>
                 <div class="col-sm-6 col-md-6" align="center">
                    <img id="showImage" src="{{ (!empty($user->image)) ? url('backend/backend/all-images/others/cost/'.$user->image): url('backend/all-images/others/default/cost.png') }}" alt="image" class="img-fluid avatar-lg rounded"/><br/>
