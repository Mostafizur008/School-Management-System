...
<div class="col-sm-6 col-md-3">
    <div class="form-group">
        ...
        <input type="text" name="institution_2" class="form-control" id="institution_2" placeholder="Enter Institution">
    </div>
 </div>
 ...
 <div class="col-sm-6 col-md-2">
    <div class="form-group">
        <label>Role</label>
        <input type="text" name="roll_2" class="form-control" id="roll_2" placeholder="Enter Role">
    </div>
 </div>
 ...
 <div class="col-sm-6 col-md-2">
    <div class="form-group">
        ...
        <input type="text" name="point_2" class="form-control" id="point_2" placeholder="Enter Grade Point">
    </div>
 </div>
