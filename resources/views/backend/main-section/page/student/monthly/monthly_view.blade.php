                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Monthly-fee</a></li>
                        </ol>
                    </div>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                  ...
                  <div class="col-sm-6 col-md-3">
                    <div class="form-group">
                        <select name="month" id="month" required="" class="form-control" data-toggle="select2">
...
@include('backend.code-section.ajax-script.student.monthfee')
