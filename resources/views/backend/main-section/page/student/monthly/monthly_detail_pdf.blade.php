...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Invoice | Monthly Fee</title>
    ...
    $registrationfee = App\Models\Category\FeeAmount\FeeAmount::where('fee_category_id','2')->where('class_id',$detail->class_id)->first();
				...
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<img src="{{public_path('backend/all-images/database/student/'.$detail['st_name']['image']) }}" style="width: 60%; max-width: 70px" />
								</td>
