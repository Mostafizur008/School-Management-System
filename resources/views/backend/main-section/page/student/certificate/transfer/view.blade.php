  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">Please provide information for Transfer Certificate</div>

        <div class="panel-body">
	  <div class="row">
	<div class="col-md-12">
        
<form action="{{route('transfer.get')}}" method="GET" target="_blank">
...
<div class="form-group ">
    <input type="submit" value="Transfer" class="btn btn-primary submit-btn center-block">
</div></div></div></form>
