    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <form action="{{route('dist.update',$editData[0]->country_id)}}}" method="post" >
                        @csrf 
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country_id" class="form-control" data-toggle="select2">
                                        ...
                                        @foreach ($country as $ct)
                                         <option  value="{{$ct->id}}" {{ ($editData['0']->country_id == $ct->id)? "selected":"" }}>{{$ct->name}}</option>
                                        @endforeach 
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-10 mb-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" value="{{$mrs->name}}" class="form-control"  placeholder="Enter District">
                                </div>
                            </div>
