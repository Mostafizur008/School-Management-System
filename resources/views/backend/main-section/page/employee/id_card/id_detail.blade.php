...
<div style="position:absolute;top:0.55in;left:1.63in;width:2in;line-height:0.14in;"><img src="{{public_path('backend/all-images/database/employee/'.$id->image) }}" height="100" width="90" /></div>
