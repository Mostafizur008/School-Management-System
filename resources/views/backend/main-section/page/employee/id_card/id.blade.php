...
<form action="{{route('em.card.get')}}" method="GET" target="_blank">

 

<div class="row" id="col_4"><div id="row_result_type"><div class="form-group col-md-5">

    <label><font color="red">Employee Id No</font></label></div><div class="form-group col-md-7">

        <input type="text" name="em_id_no" id="em_id_no" required class="form-control">
