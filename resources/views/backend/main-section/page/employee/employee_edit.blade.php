    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Employee-Edit</a></li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-box">
             <form action="{{route('emp.update',$editData->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mrs">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                           <div class="form-group">
                               ...
                               <select id="marital" name="marital" class="form-control" data-toggle="select2">
                                   <option disable="">Choose one</option>
                                   <option value="Singal" {{ ($editData->religion == 'Singal')? "selected": ""}}>Singal</option>
                                   <option value="Marrid" {{ ($editData->religion == 'Marrid')? "selected": ""}}>Marrid</option>
                                   <option value="Separate" {{ ($editData->religion == 'Separate')? "selected": ""}}>Separate</option>
                                   <option value="Devorce" {{ ($editData->religion == 'Devorce')? "selected": ""}}>Devorce</option>
                               </select>
                           </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
