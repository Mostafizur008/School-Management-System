    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-box">
            <form action="{{route('salary.increment.store',$editData->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12" align="center">
                            ...
                            <p class="text-muted mt-0 mb-1 pt-0 fs-13">{{$editData->th_id_no}}</p>
                        </div>
