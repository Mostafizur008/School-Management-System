                            ...
                            <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{$salary->gender}}</td>
                                        <td>{{$salary->mobile}}</td>
                                        <td>{{$salary->th_id_no}}</td>
                                        <td>{{date('d-m-Y',strtotime($salary->join_date))}}</td>
                                        <td>BDT. {{$salary->salary}}</td>
                                        <td style="width: 11%;">
                                            @if ($usr->can('Admin.edit'))  <a href="{{route('salary.detail',$salary->id)}}" class="btn btn-xs btn-pink"><i class="fe-eye"></i></a> @endif
                                            @if ($usr->can('Admin.edit'))  <a href="{{route('salary.increment',$salary->id)}}" class="btn btn-xs btn-primary"><i class="fe-plus"></i></a> @endif
                                        </td>
                                    </tr>
                                </tbody>
                                @endforeach
