    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-box">
             <form action="{{route('leave.update',$editData->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                           <div class="form-group">
                               ...
                               <select name="teacher_id" class="form-control" data-toggle="select2">
                                   ...
                                   <option value="{{$th->id}}" {{ ($editData->teacher_id == $th->id)? 'selected':'' }}>{{$th->name}}</option>
                                   @endforeach
                               </select>
                           </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select name="leave_purpose_id" id="leave" class="form-control" data-toggle="select2">
                                    ...
                                    <option value="{{$lp->id}}" {{ ($editData->leave_purpose_id == $lp->id)? 'selected':''}}>{{$lp->name}}</option>
                                    @endforeach
