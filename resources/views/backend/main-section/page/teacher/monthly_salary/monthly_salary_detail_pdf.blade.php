...
<img style="position:absolute;top:0.40in;left:0.50in;width:0.73in;height:0.73in" src="{{public_path('backend/all-images/database/teacher/'.$detail['0']['user']['image'])}}" />
...
<div style="position:absolute;top:1.30in;left:0.45in;width:3.57in;line-height:0.25in;"><span style="font-style:normal;font-weight:normal;font-size:12pt;font-family:Segoe UI;color:#212529">Teacher's Id: </span><span style="font-style:normal;font-weight:bold;font-size:12pt;font-family:Segoe UI;color:#212529">{{ $detail['0']['user']['th_id_no'] }}</span><span style="font-style:normal;font-weight:bold;font-size:12pt;font-family:Segoe UI;color:#212529"> </span><br/></SPAN></div>
