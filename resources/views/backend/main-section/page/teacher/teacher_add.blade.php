    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Teacher-add</a></li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-box">
             <form action="{{route('teacher.reg.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mrs">
                    <div class="row">
                        <div class="col-sm-12 col-md-12" align="center">
                            <img id="showImage" src="{{ (!empty($user->image)) ? url('backend/all-images/database/teacher/'.$user->image): url('backend/all-images/database/default/mps.png') }}" alt="image" class="img-fluid avatar-lg rounded"/><br/>
                        ...
                        <hr/>
                            ...
                            @include('backend.code-section.modal.teacher.teacher.addmore.ssc')
                          
                            <!------------------------------------------HSC-------------------------------------------->
                          
                            @include('backend.code-section.modal.teacher.teacher.addmore.hsc')
        ...
        @include('backend.code-section.modal.teacher.teacher.addmore.graduation')
        @include('backend.code-section.modal.teacher.teacher.addmore.post_graduation')
        @include('backend.code-section.jquery.scripts.dependence')

        <script type="text/javascript">

            @include('backend.main-section.page.teacher.ajax.imageshow')
            @include('backend.main-section.page.teacher.ajax.addmore')
