    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <form action="{{route('issue.update',$editData[0]->user_id)}}" method="post" >
                        @csrf 
                            ...
                            <div class="form-group col-md-12 mb-0">
                                <div class="form-group">
                                    ...
                                    <select name="user_id" class="form-control" data-toggle="select2">
                                        ...
                                        @foreach ($user as $us)
                                        <option value="{{$us->id}}" {{ ($editData['0']->user_id == $us->id)? "selected":"" }}>{{$us->name}}</option>
                                        @endforeach 
                                        </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 mb-0">
                                <div class="form-group">
                                    ...
                                    <select name="session_id[]" class="form-control" data-toggle="select2">
                                        ...
                                        <option  value="{{$sb->id}}" {{ ($mrs->session_id == $sb->id)? "selected":"" }}>{{$sb->name}}</option>
                                        @endforeach 
                                        </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 mb-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_no[]" value="{{$mrs->id_no}}" class="form-control"  placeholder="Id No">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 mb-0">
                                <div class="form-group">
                                    ...
                                    <select name="book_id[]" class="form-control" data-toggle="select2">
                                        <option value="" selected="" disabled="">Chose One</option>
                                        @foreach ($book as $bc)
                                        <option  value="{{$bc->id}}" {{ ($mrs->book_id == $bc->id)? "selected":"" }}>{{$bc->name}}</option>
                                        @endforeach 
                                        </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 mb-0">
                                <div class="form-group">
                                    ...
                                    <select name="author_id[]" class="form-control" data-toggle="select2">
                                        ...
                                        <option  value="{{$at->id}}" {{ ($mrs->author_id == $at->id)? "selected":"" }}>{{$at->name}}</option>
                                        @endforeach 
                                        </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 mb-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start[]" value="{{$mrs->start}}" class="form-control" data-toggle="flatpicker" placeholder="March 9, 2020">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 mb-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="end[]" value="{{$mrs->end}}" class="form-control" data-toggle="flatpicker" placeholder="March 9, 2020">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-3 mb-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="return[]" value="{{$mrs->return}}" class="form-control" data-toggle="flatpicker" placeholder="March 9, 2020">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status[]" class="form-control" data-toggle="select2">
                                        ...
                                        <option value="Active" {{ ($mrs->status == "Active" )? "selected": ""}}>Active</option>
                                        <option value="Returns" {{ ($mrs->status == "Returns" )? "selected": ""}}>Returns</option>
                                        <option value="Cencel" {{ ($mrs->status == "Cencel" )? "selected": ""}}>Cencel</option>
                                    </select>
                                </div>
                             </div>
