        ...
        <div class="row">
            <div class="col-12">
                <div class="card-header">
                    <div class="col-lg-12" align="right"> <a href="{{route('fee.add')}}" class="btn btn-primary">Student Fee</a> </div>
                </div>
                <div class="card-box">
                    <div class="mb-2">
                        <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="demo-foo-filtering" class="table table-bordered table-centered mb-0" data-page-size="5">
                            ...
                            <tr>
                                <td>#{{ $key+1 }}</td>
                                <td> {{ $value['st_name']['id_no'] }}</td>	
                                <td> {{ $value['st_name']['name'] }}</td>	
                                <td> {{ $value['session_name']['name'] }}</td>	
                                <td> {{ $value['class_name']['name'] }}</td>	
                                <td> {{ $value['fee_cat']['name'] }} </td>	
                                <td> {{ $value->amount }}</td>
